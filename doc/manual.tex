...
It also contains an empty Template example (in the Templates/BasicModel
...
(Templates/BasicModel), there's not
...
Templates/JuliaModel directory. There's a HOWTO file in that directory
