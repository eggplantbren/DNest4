...
\pkg{MultiNest} \citep{feroz2009multinest} is a Nested Sampling implementation
...
\pkg{Pandas} \citep{pandas}, and \pkg{Cython} \citep{cython} are also needed.
