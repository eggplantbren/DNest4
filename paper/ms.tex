...
(see Section~\ref{sec:models} for details) and is included in the
...
\end{minipage}
\begin{minipage}{0.5\textwidth}
\includegraphics[width=8cm]{figures/regression_lines.pdf}
...
value on problems with a large information.
