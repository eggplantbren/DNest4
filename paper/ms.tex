...
To help with implementing the member functions for the \code{MyModel} class,
the \code{gaussians} object can be generated from its prior, proposed,
...
simulated data set from the parameters along with a collection of
numbers which are the results of random number calls.
The random numbers are independent of the parameters and
can be used to parameterize the data set.
