...
\author{Brendon J. Brewer\\The University of Auckland\And 
        Dan Foreman-Mackey\\Washington}
\title{\pkg{DNest4}: An implementation of Diffusive Nested Sampling in
C++11 and Python}

%% for pretty printing and a nice hypersummary also set:
\Plainauthor{Brendon J. Brewer, Dan Foreman-Mackey} %% comma-separated
...
\Abstract{DNest4 is good.}

\Keywords{keywords, comma-separated, not capitalized, \proglang{C++11},
\proglang{Python}}
