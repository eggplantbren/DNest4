...
$(m, b, \sigma)$ is modified.

\subsection{Proposals for single parameters}
The proposal for $m$ involves adding a perturbation to the current value
using the line \code{m += 1E3*rng.randh();}.
...
The factor of \code{1E3} is
included to account for the prior width.
