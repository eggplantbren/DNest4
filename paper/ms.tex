...
\begin{CodeChunk}
\begin{CodeInput}
> wget https://github.com/eggplantbren/DNest4/archive/0.1.2.tar.gz
> tar xvzf 0.1.2.tar.gz
> mv DNest4-0.1.2 DNest4
> cd DNest4/code
> make
> cd ../python
...
\section{Finite mixture models with the RJObject class}
