...
this, although alternatives exist \citep[e.g.][]{multinest}.
...
\end{align}
where $\{\ell_j\}$ is a sequence of increasing likelihood thresholds
or {\em levels}, and
...
\pkg{DNest4} can be obtained from the \pkg{git} repository at
{\tt https://github.com/eggplantbren/DNest4/} and is licensed under the
MIT license. To obtain \pkg{DNest4} and compile and install the software,
you require \pkg{git} and a recent version of \pkg{g++}. The \proglang{Python}
...
regression example, this is achieved by having a Data class to represent
datasets. The dataset using the {\em singleton pattern}.
