...
\Abstract{In probabilistic (Bayesian) inferences, we typically want to
  ...
  for finite mixture models; (ii) a \proglang{Python} package allowing
  basic use without \proglang{C++} coding; and iii) experimental
  support for models implemented in \proglang{Julia}.  In this paper
